...
Nova.booting(function (Vue, router) {
    Vue.component('index-nova-media-library-image-field', __webpack_require__(3));
    Vue.component('detail-nova-media-library-image-field', __webpack_require__(6));
    Vue.component('form-nova-media-library-image-field', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _vm.url
    ? _c("div", { staticClass: "rounded-full w-8 h-8", style: _vm.style })
    : _c("span", [_vm._v("—")])
}
var staticRenderFns = []
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nova_resources_js_components_ImageLoader__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nova_resources_js_components_DeleteButton__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_laravel_nova__ = __webpack_require__(26);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        this.field.fill = function (formData) {
            formData.append(_this2.field.attribute, _this2.file, _this2.fileName);

            for (var attribute in _this2.field) {
                if (attribute.substr(0, 3) === 'ml_') {
                    formData.append(attribute, _this2.field[attribute]);
                }
            }
        };
    },
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                uri = '/nova-vendor/jameslkingsley/nova-media-library/' + this.field.value.id;
                                _context.prev = 4;
                                _context.next = 7;
...
var update = __webpack_require__(18)("e1f4f252", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../../nova-components/NovaMediaLibrary/node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-95792408\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../nova-components/NovaMediaLibrary/node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ImageLoader.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../../nova-components/NovaMediaLibrary/node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-95792408\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../nova-components/NovaMediaLibrary/node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ImageLoader.vue");
...
var _laravelNova = __webpack_require__(21);
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        (0, _laravelNova.Minimum)(Nova.request().get(this.src, {
            responseType: 'blob'
        })).then(function (_ref) {
            ...
            _this.$refs.card.$el.appendChild(newImage);
            _this.loading = false;
                ...
                _vm.field.value && !_vm.field.thumbnailUrl
                  ? [
                      _c(
                        ...
                        {
                          staticClass:
                            "flex item-center relative overflow-hidden"
                        },
                        [
                          _vm.field.value
                            ? _c("img", {
                                staticClass: "rounded",
                                style: {
                                  width: _vm.field.width || "auto",
                                  height: _vm.field.height || "12rem"
                                },
